...
fn generate_component_reflection() -> Result<ComponentReflectionMap, SerializationError> {
    ...
    let array = [
        ...
        (
            <ChronicleConfidence as Component>::name(),
            ComponentReflection {
                docstring_md: "Confidence score (0.0 to 1.0) for a Chronicle event link.\n\nControls visual opacity of link arcs in the ChronicleTimelineView.",
                deprecation_summary: None,
                custom_placeholder: Some(ChronicleConfidence::default().to_arrow()?),
                datatype: ChronicleConfidence::arrow_datatype(),
                is_enum: false,
                verify_arrow_array: ChronicleConfidence::verify_arrow_array,
            },
        ),
        (
            <ChronicleEntityId as Component>::name(),
            ComponentReflection {
                docstring_md: "The ID of a Chronicle entity (e.g. \"cust_123\", \"tkt_456\", \"sess_789\").",
                deprecation_summary: None,
                custom_placeholder: Some(ChronicleEntityId::default().to_arrow()?),
                datatype: ChronicleEntityId::arrow_datatype(),
                is_enum: false,
                verify_arrow_array: ChronicleEntityId::verify_arrow_array,
            },
        ),
        (
            <ChronicleEntityType as Component>::name(),
            ComponentReflection {
                docstring_md: "The type of a Chronicle entity reference (e.g. \"customer\", \"account\", \"session\", \"ticket\").",
                deprecation_summary: None,
                custom_placeholder: Some(ChronicleEntityType::default().to_arrow()?),
                datatype: ChronicleEntityType::arrow_datatype(),
                is_enum: false,
                verify_arrow_array: ChronicleEntityType::verify_arrow_array,
            },
        ),
        (
            <ChronicleEventType as Component>::name(),
            ComponentReflection {
                docstring_md: "The type of a Chronicle event (e.g. \"payment_intent.succeeded\", \"ticket.created\").",
                deprecation_summary: None,
                custom_placeholder: Some(ChronicleEventType::default().to_arrow()?),
                datatype: ChronicleEventType::arrow_datatype(),
                is_enum: false,
                verify_arrow_array: ChronicleEventType::verify_arrow_array,
            },
        ),
        (
            <ChronicleLinkType as Component>::name(),
            ComponentReflection {
                docstring_md: "The type of a causal link between Chronicle events (e.g. \"caused_by\", \"led_to\", \"triggered\").",
                deprecation_summary: None,
                custom_placeholder: Some(ChronicleLinkType::default().to_arrow()?),
                datatype: ChronicleLinkType::arrow_datatype(),
                is_enum: false,
                verify_arrow_array: ChronicleLinkType::verify_arrow_array,
            },
        ),
        (
            <ChroniclePayload as Component>::name(),
            ComponentReflection {
                docstring_md: "The JSON payload of a Chronicle event, serialized as a UTF-8 string.",
                deprecation_summary: None,
                custom_placeholder: Some(ChroniclePayload::default().to_arrow()?),
                datatype: ChroniclePayload::arrow_datatype(),
                is_enum: false,
                verify_arrow_array: ChroniclePayload::verify_arrow_array,
            },
        ),
        (
            <ChronicleReasoning as Component>::name(),
            ComponentReflection {
                docstring_md: "Human-readable reasoning for why a Chronicle link was created.",
                deprecation_summary: None,
                custom_placeholder: Some(ChronicleReasoning::default().to_arrow()?),
                datatype: ChronicleReasoning::arrow_datatype(),
                is_enum: false,
                verify_arrow_array: ChronicleReasoning::verify_arrow_array,
            },
        ),
        (
            <ChronicleSource as Component>::name(),
            ComponentReflection {
                docstring_md: "The data source of a Chronicle event (e.g. \"stripe\", \"support\", \"product\").",
                deprecation_summary: None,
                custom_placeholder: Some(ChronicleSource::default().to_arrow()?),
                datatype: ChronicleSource::arrow_datatype(),
                is_enum: false,
                verify_arrow_array: ChronicleSource::verify_arrow_array,
            },
        ),
        (
            <ChronicleSourceEvent as Component>::name(),
            ComponentReflection {
                docstring_md: "Entity path of the source event in a Chronicle link.",
                deprecation_summary: None,
                custom_placeholder: Some(ChronicleSourceEvent::default().to_arrow()?),
                datatype: ChronicleSourceEvent::arrow_datatype(),
                is_enum: false,
                verify_arrow_array: ChronicleSourceEvent::verify_arrow_array,
            },
        ),
        (
            <ChronicleTargetEvent as Component>::name(),
            ComponentReflection {
                docstring_md: "Entity path of the target event in a Chronicle link.",
                deprecation_summary: None,
                custom_placeholder: Some(ChronicleTargetEvent::default().to_arrow()?),
                datatype: ChronicleTargetEvent::arrow_datatype(),
                is_enum: false,
                verify_arrow_array: ChronicleTargetEvent::verify_arrow_array,
            },
        ),
        (
            <ChronicleTopic as Component>::name(),
            ComponentReflection {
                docstring_md: "The topic of a Chronicle event (e.g. \"payments\", \"tickets\", \"usage\").",
                deprecation_summary: None,
                custom_placeholder: Some(ChronicleTopic::default().to_arrow()?),
                datatype: ChronicleTopic::arrow_datatype(),
                is_enum: false,
                verify_arrow_array: ChronicleTopic::verify_arrow_array,
            },
        ),
        (
...
fn generate_archetype_reflection() -> ArchetypeReflectionMap {
    ...
    let array = [
        ...
        (
            ArchetypeName::new("rerun.archetypes.ChronicleEntityRef"),
            ArchetypeReflection {
                display_name: "Chronicle entity ref",
                deprecation_summary: None,
                scope: None,
                view_types: &["ChronicleTimelineView"],
                fields: vec![
                    ArchetypeFieldReflection {
                        name: "entity_type",
                        display_name: "Entity type",
                        component_type: "rerun.components.ChronicleEntityType".into(),
                        docstring_md: "The type of the referenced entity (e.g. \"customer\", \"account\", \"ticket\").",
                        flags: ArchetypeFieldFlags::REQUIRED | ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "entity_id",
                        display_name: "Entity id",
                        component_type: "rerun.components.ChronicleEntityId".into(),
                        docstring_md: "The ID of the referenced entity (e.g. \"cust_123\", \"tkt_456\").",
                        flags: ArchetypeFieldFlags::REQUIRED | ArchetypeFieldFlags::UI_EDITABLE,
                    },
                ],
            },
        ...
        (
            ArchetypeName::new("rerun.archetypes.ChronicleEvent"),
            ArchetypeReflection {
                display_name: "Chronicle event",
                deprecation_summary: None,
                scope: None,
                view_types: &["TextLogView", "ChronicleTimelineView"],
                fields: vec![
                    ArchetypeFieldReflection {
                        name: "source",
                        display_name: "Source",
                        component_type: "rerun.components.ChronicleSource".into(),
                        docstring_md: "The data source (e.g. \"stripe\", \"support\", \"product\", \"marketing\").",
                        flags: ArchetypeFieldFlags::REQUIRED | ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "event_type",
                        display_name: "Event type",
                        component_type: "rerun.components.ChronicleEventType".into(),
                        docstring_md: "The event type (e.g. \"payment_intent.succeeded\", \"ticket.created\").",
                        flags: ArchetypeFieldFlags::REQUIRED | ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "topic",
                        display_name: "Topic",
                        component_type: "rerun.components.ChronicleTopic".into(),
                        docstring_md: "The topic/category (e.g. \"payments\", \"tickets\", \"usage\").",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "payload",
                        display_name: "Payload",
                        component_type: "rerun.components.ChroniclePayload".into(),
                        docstring_md: "JSON payload serialized as a string.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "color",
                        display_name: "Color",
                        component_type: "rerun.components.Color".into(),
                        docstring_md: "Optional color for the event marker.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "label",
                        display_name: "Label",
                        component_type: "rerun.components.Text".into(),
                        docstring_md: "Optional text label.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                ],
            },
        ...
        (
            ArchetypeName::new("rerun.archetypes.ChronicleLink"),
            ArchetypeReflection {
                display_name: "Chronicle link",
                deprecation_summary: None,
                scope: None,
                view_types: &["ChronicleTimelineView"],
                fields: vec![
                    ArchetypeFieldReflection {
                        name: "source_event",
                        display_name: "Source event",
                        component_type: "rerun.components.ChronicleSourceEvent".into(),
                        docstring_md: "Entity path of the source event.",
                        flags: ArchetypeFieldFlags::REQUIRED | ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "target_event",
                        display_name: "Target event",
                        component_type: "rerun.components.ChronicleTargetEvent".into(),
                        docstring_md: "Entity path of the target event.",
                        flags: ArchetypeFieldFlags::REQUIRED | ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "link_type",
                        display_name: "Link type",
                        component_type: "rerun.components.ChronicleLinkType".into(),
                        docstring_md: "Type of the link (e.g. \"caused_by\", \"led_to\", \"triggered\", \"related_to\").",
                        flags: ArchetypeFieldFlags::REQUIRED | ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "confidence",
                        display_name: "Confidence",
                        component_type: "rerun.components.ChronicleConfidence".into(),
                        docstring_md: "Confidence score (0.0 to 1.0). Controls arc opacity in the viewer.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "reasoning",
                        display_name: "Reasoning",
                        component_type: "rerun.components.ChronicleReasoning".into(),
                        docstring_md: "Human-readable reasoning for why this link exists.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "color",
                        display_name: "Color",
                        component_type: "rerun.components.Color".into(),
                        docstring_md: "Optional color override for the link arc.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                ],
            },
